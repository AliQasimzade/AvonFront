...
const Header = (props) => {
  ...
  if (userData?.id) {
    const myAccount = useQuery('myaccount', async() => {
      const res1 =  getMyAccount(userData?.id);
      const res2 = getAllBasket(userData?.id)
   ...
   if(myAccount.isFetched) {
   
    dispatch(changeAccont(myAccount.data[0]));
    dispatch(getAllBaskets(myAccount.data[1]));
   }
              ...
              <Row>
                  ...
                  <div className="d-flex align-items-center justify-content-end">
                    ...
                    >
                      ...
                      >
                        ...
                        >
                          <i className="bi bi-sun align-middle me-2"></i>{" "}
                          Defualt (light mode)
                        </Dropdown.Item>
                        <Dropdown.Item
                          eventKey="dark"
                        ...
                        <Dropdown.Item
                          ...
                          onClick={() => props.handleMood("light")}
                        >
                          <i className="bi bi-moon-stars align-middle me-2"></i>{" "}
                          Auto (system defualt)
                        </Dropdown.Item>
                      </Dropdown.Menu>
                    </Dropdown>
                      ...
                      {userData?.email ? (
                        <Dropdown>
                          ...
                          <Dropdown.Menu>
                            ...
                            <Dropdown.Item href="/sifaris-izleme">
                            ...
                            <Dropdown.Item href="/hesabim/balans-tarixcesi">
                        ...
                        <div className="d-flex align-items-center">
                          <Link className="d-flex" to={"/giris"}>
                            ...
                            />
                            <span className="ms-2 text-black d-none d-md-flex">
                              Daxil ol{" "}
                            </span>
                          </Link>
                ...
                <div className="col-12 ">
                  ...
                  >
                    <Nav
                      as="ul"
                      className="mx-lg-auto mb-2 w-100 mb-lg-0 navbar_responsive_flex  justify-content-end"
                      id="navigation-menu"
                    >
                      <div className="d-flex d-lg-none w-100 align-items-center justify-content-between">
                        <li className="nav-item d-block d-lg-none">
                          ...
                          >
                            {" "}
                            <Image src={AvonLogo} alt="" height="85" />
                          </Link>
                        </li>
                        <li className="X_menu">
                                    ...
                                    {category.subCategories.map(
                                      (subcategory, subIndex) => (
                                        <li className="nav-item" key={subIndex}>
                                          <Link
                                            to={`/kateqoriyalar/${subcategory.slug}`}
                                            className="nav-link"
