                                    ...
                                    <div className="accordion-collapse collapse show" aria-labelledby="flush-headingSize">
                                        <div className="accordion-body text-body pt-0">
                                            <ul className="clothe-size list-unstyled hstack gap-3 mb-0 flex-wrap" id="size-filter">
                                                <li>
                                                    <Form.Control type="radio" name="sizes" value="xs" id="sizeXs" onClick={(e) => handleSize(e.target)} />
                                                ...
                                                <li>
                                                    <Form.Control type="radio" name="sizes" value="s" id="sizeS" onClick={(e) => handleSize(e.target)} />
                                                ...
                                                <li>
                                                    <Form.Control type="radio" name="sizes" value="m" id="sizeM" onClick={(e) => handleSize(e.target)} />
                                                ...
                                                <li>
                                                    <Form.Control type="radio" name="sizes" value="l" id="sizeL" onClick={(e) => handleSize(e.target)} />
                                                ...
                                                <li>
                                                    <Form.Control type="radio" name="sizes" value="xl" id="sizeXl" onClick={(e) => handleSize(e.target)} />
                                                ...
                                                <li>
                                                    <Form.Control type="radio" name="sizes" value="2xl" id="size2xl" onClick={(e) => handleSize(e.target)} />
                                                ...
                                                <li>
                                                    <Form.Control type="radio" name="sizes" value="3xl" id="size3xl" onClick={(e) => handleSize(e.target)} />
                                                ...
                                                <li>
                                                    <Form.Control type="radio" name="sizes" value="4xl" id="size4xl" onClick={(e) => handleSize(e.target)} />
